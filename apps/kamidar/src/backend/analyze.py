...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Analyze image fragments by color")
    parser.add_argument("--image_source", required=True, help="Path to the image file")
    parser.add_argument("--color_input", required=True, help="Hex color code (e.g. #A98876)")
    parser.add_argument("--gps", required=True, help="GPS Coordinate (e.g. 37.7749,-122.4194)")

    args = parser.parse_args()

    # Prepare data dict for analyze()
    data = {
